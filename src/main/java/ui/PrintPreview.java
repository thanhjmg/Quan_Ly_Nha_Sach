...
public class PrintPreview extends JDialog {
	...
	public PrintPreview(JDialog owner, HoaDon hoaDon) {
		...
		txtSanPhamTitle.setMaximumSize(new Dimension(150, 50));
		txtSanPhamTitle.setMinimumSize(new Dimension(150, 50));
//		txtSanPhamTitle.setSize(150,5);
		...
		for(CTHoaDon item : ds) {
			...
			txtTenSanPham.setMaximumSize(txtSanPhamTitle.getMaximumSize());
