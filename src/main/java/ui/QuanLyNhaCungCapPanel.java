...
//		btnXoa.addActionListener(this);
	...
	private void addNorth() {
		...
		btnSua = addButtonTo(boxButton, "Sửa nhà cung cấp", "Images/modify.png", UIConstant.PRIMARY_COLOR);
		btnXoaRong = addButtonTo(boxButton, "Xoá rỗng", "Images/empty.png", new Color(198, 0, 0));
...
//		txtSoFax.setBackground(new Color(214,182,180));
		...
		btnTKXoaRong = addButtonTo(boxTKButton, "Xoá rỗng", "Images/empty.png", new Color(198, 0, 0));
		btnTKXoaRong.setBorderRadius(30);
		btnXoa = addButtonTo(boxButton, "Xoá nhà cung cấp", "Images/delete.png", new Color(198, 0, 0));
