...
//		pnlSouth.add(btnSua);
	...
	private void addCenter() {
		...
		String[] columns = new String[] { "Mã khách hàng", "Tên khách hàng", "Ngày sinh", "Địa chỉ", "Giới tính", "Email", "Số điện thoại" };
...
//		txtEmail2.set;
		...
		btnXoaTrang2 = new ColoredButton("Xóa rỗng", new ImageIcon("img/empty.png"));
	...
	private void addNorth() {
		...
		btnXoaTrang = new ColoredButton("Xóa rỗng", new ImageIcon("img/empty.png"));
